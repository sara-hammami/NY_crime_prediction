...
model = joblib.load(r"saved_modals/xgboost.joblib")
crime_classes = {0:'Violation',1:"Misdemeanor",2:"Felony"}
felony = open(r"crime_classes/felony.txt","r").read()
mis = open(r"crime_classes/misdemeanor.txt","r").read()
violation = open(r"crime_classes/violation.txt","r").read()
