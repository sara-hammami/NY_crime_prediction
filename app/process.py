...
model = joblib.load(r"D:/AIM-tbourbi/projet/app/saved_modals/xgboost.joblib")
crime_classes = {0:'Violation',1:"Misdemeanor",2:"Felony"}
felony = open(r"D:/AIM-tbourbi/projet/app/crime_classes/felony.txt","r").read()
mis = open(r"D:/AIM-tbourbi/projet/app/crime_classes/misdemeanor.txt","r").read()
violation = open(r"D:/AIM-tbourbi/projet/app/crime_classes/violation.txt","r").read()
